...
const Team = () => {
  ...
  return (
    <div className="mt-1 bg-gradient-to-r from-orange-100 via-white to-blue-100 py-16 min-h-[94vh]">
      <div className="relative flex justify-center items-center mb-12">
        {/* Admin Button */}
        {/* {isAdminVisible && (
          <Link to="/all-dishes">
            <button className="fixed top-20 right-2 bg-blue-500 text-white px-4 py-2 rounded-lg z-50 mt-10">
              Admin
            </button>
          </Link>
        )} */}
        ...
        >
          ...
          <h1 className=" mt-10 text-4xl font-extrabold text-center text-gray-800 px-8">
            Meet Our Team!
          </h1>
      ...
      <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 px-8 lg:px-24">
        {teamMembers.map((member, index) => (
          <div
            key={index}
            className="mt-10 relative bg-gradient-to-b from-blue-100 via-white to-gray-50 rounded-tl-[2rem] rounded-br-[2rem] shadow-lg hover:shadow-xl transition-transform transform hover:scale-105"
          >
